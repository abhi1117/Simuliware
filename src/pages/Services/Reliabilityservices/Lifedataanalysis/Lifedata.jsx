...
export default function Lifedatacard() {
    return (
        ...
        <div style={{ textAlign: 'center', marginRight: '100px', paddingTop: '10px', marginLeft: '150px' }}>
        <h2 style={{ color: '#BC1E1E', paddingBottom: '10px', textAlign: 'center', fontSize: '30px' }}>Reliability Solutions</h2>
            <h6 style={{ paddingBottom: '40px', color: '#d14a3b', paddingTop: '15px',textDecoration: 'underline', fontSize: '24px' }}>Life Data Analysis</h6>
